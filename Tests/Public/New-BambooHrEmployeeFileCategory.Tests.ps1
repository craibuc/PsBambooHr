BeforeAll {
    ...
    # New-BambooHrEmployeeFileCategory.ps1
...
Describe "New-BambooHrEmployeeFileCategory" -Tag 'unit' {

    Context "Parameter validation" {

        BeforeAll {
            $Command = Get-Command 'New-BambooHrEmployeeFileCategory'
        } 
    ...
    Context "Usage" {
        ...
        Context "Request" {
            ...
            BeforeEach {
                # act
                New-BambooHrEmployeeFileCategory -ApiKey $ApiKey -Subdomain $Subdomain -Name $Name
            }
            ...
            It "uses the correct Uri" {
                ...
                Assert-MockCalled Invoke-WebRequest -ParameterFilter { 
                    Write-Debug "Uri: $Uri"
                    $Uri -eq "https://api.bamboohr.com/api/gateway.php/$Subdomain/v1/employees/files/categories"
                }
            }
            ...
            It "uses the correct Body" {
                # assert
                Assert-MockCalled Invoke-WebRequest -ParameterFilter { $Body -eq ( $Name | ConvertTo-Json ) }
            }
