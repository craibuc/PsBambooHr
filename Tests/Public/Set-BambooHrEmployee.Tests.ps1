BeforeAll {
    ...
    # Set-BambooHrEmployee.ps1
    $SUT = (Split-Path -Leaf $PSCommandPath) -replace '\.Tests\.', '.'

    # . /PsBambooHr/PsBambooHr/Public/Set-BambooHrEmployee.ps1
    . (Join-Path $PublicPath $SUT)

}

Describe "Set-BambooHrEmployee" -Tag 'unit' {

    Context "Parameter validation" {

        BeforeAll {
            $Command = Get-Command 'Set-BambooHrEmployee'
        }
    ...
    Context "Usage" {
        ...
        BeforeAll {
            ...
            Mock Invoke-WebRequest {
                $Fixture = 'Update-Employee.Response.json'
        ...
        BeforeEach {
            # act
            Set-BambooHrEmployee -ApiKey $ApiKey -Subdomain $Subdomain @Employee
        }
        ...
        Context "Request" {
            ...
            It "uses the correct Uri" {
                # assert
                Assert-MockCalled Invoke-WebRequest -ParameterFilter { $Uri -eq "https://api.bamboohr.com/api/gateway.php/$Subdomain/v1/employees/$( $Employee.id )" }
            }
            ...
            It "creates the correct Body" {
                ...
                Assert-MockCalled Invoke-WebRequest -ParameterFilter { 
                    ...
                    $Expected.PSObject.Properties.Remove('Id') 

                    $Actual = $Body | ConvertFrom-Json
    
                    $Delta = Compare-Object -ReferenceObject @($Expected.PsObject.Properties | Select-Object Name, Value) -DifferenceObject @($Actual.PsObject.Properties | Select-Object Name, Value)
